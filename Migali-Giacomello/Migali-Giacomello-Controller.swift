...
class MigaliGiacomelloController: UIViewController {
    ...
    func riempiInsieme()
    {
        ...
        outlet1.backgroundColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 0)
        outlet1.tag = listaNumeri[0]
        outlet2.setTitle(String(listaNumeri[1]), for: .normal)
        outlet2.backgroundColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 0)
        outlet2.tag = listaNumeri[1]
        outlet3.setTitle(String(listaNumeri[2]), for: .normal)
        outlet3.backgroundColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 0)
        outlet3.tag = listaNumeri[2]
        outlet4.setTitle(String(listaNumeri[3]), for: .normal)
        outlet4.backgroundColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 0)
        outlet4.tag = listaNumeri[3]
        outlet5.setTitle(String(listaNumeri[4]), for: .normal)
        outlet5.backgroundColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 0)
        outlet5.tag = listaNumeri[4]
        outlet6.setTitle(String(listaNumeri[5]), for: .normal)
        outlet6.backgroundColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 0)
        outlet6.tag = listaNumeri[5]
        outlet7.setTitle(String(listaNumeri[6]), for: .normal)
        outlet7.backgroundColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 0)
        outlet7.tag = listaNumeri[6]
        outlet8.setTitle(String(listaNumeri[7]), for: .normal)
        outlet8.backgroundColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 0)
